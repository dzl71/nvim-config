...
vim.keymap.set({ "n", "v", "i", "c", "s" }, "<C-s>", "<Esc><Cmd>noh<CR><Cmd>w<CR>") -- save and exit modes
vim.keymap.set("n", "<leader>yy", '"+yy')                                           -- copy line to clippboard
vim.keymap.set("v", "<leader>y", '"+y')                                             -- coppy selected text to clippboard
vim.keymap.set("n", "<leader>p", '"+p')                                             -- coppy selected text to clippboard
vim.keymap.set("n", "<leader>P", '"+P')                                             -- coppy selected text to clippboard
...
vim.keymap.set('n', '<leader>ls', telescope.live_grep, {})
vim.keymap.set('n', '<leader>gs', telescope.current_buffer_fuzzy_find, {})
...
-- make indentations more readable
